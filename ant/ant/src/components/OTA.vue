  ...
  <v-card>
    <v-card-text>
      <div>
        ...
        <input type="file" id="selectedFile" accept=".bin" style="display: none;" @change="myFunction()"/>
        <input type="button" value="Browse..." onclick="document.getElementById('selectedFile').click();"/>
        <h3 id="file_info"></h3>
        <input type='submit' id="upload_button" value='Update Firmware' @click="updateFirmware()">
