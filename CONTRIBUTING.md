...
You can file new issues by selecting from our [new issue templates](https://github.com/triembed/quercus/issues/new/choose) and filling out the issue template.
...
1. Search [GitHub](https://github.com/triembed/quercus/pulls) for an open or closed PR that relates to your submission.
...
4. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the triembed/quercus repo.
...
The Quercus team reserves the right not to accept pull requests from community members who haven't been good citizens of the community. Such behavior includes not following the [code of conduct](https://github.com/triembed/code-of-conduct) and applies within or outside of our managed channels.
